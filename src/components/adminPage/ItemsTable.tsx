        ...
        <div className="overflow-x-auto rounded-xl border border-[#e6e0db] dark:border-zinc-700 bg-white dark:bg-zinc-800">
            ...
            <tbody>
                {sortedItems.map((item: ItemModel) => (
                    <tr key={item.id} className="h-14 border-b border-[#e6e0db] dark:border-zinc-700 hover:bg-bg-light dark:hover:bg-zinc-800/80 transition-colors">
                        ...
                        <td className="py-2 px-3 font-medium text-text-dark dark:text-white text-center">{item.name}</td>
                        <td className="py-2 px-3 text-text-light dark:text-zinc-400 max-w-xs truncate text-center" title={item.description ?? ''}>{item.description ?? '—'}</td>
                        <td className="py-2 px-3 text-text-dark dark:text-white font-medium text-center">{item.price}</td>
                        <td className="py-2 px-3 text-text-dark dark:text-white text-center">{categories.find((x) => x.id === item.category_id)?.name ?? 'Ismeretlen'}</td>
                        ...
                        <td className="py-2 px-3 text-text-dark dark:text-white text-center">{item.default_time_to_deliver}</td>
                        <td className="py-2 px-3 text-center">
