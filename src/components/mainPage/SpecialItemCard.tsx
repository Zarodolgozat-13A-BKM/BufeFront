...
export const SpecialItemCard = ({ item, showModal, quantity }: SpecialItemCardProps) => {
  return (
    <div 
      className={`snap-center shrink-0 flex flex-col gap-3 rounded-2xl bg-white dark:bg-gray-900 border-2 border-orange-500/20 dark:border-orange-500/40 shadow-lg hover:shadow-xl min-w-[260px] w-[260px] overflow-hidden group transition-all duration-300 ${
    ...
    >
      <div className="relative w-full aspect-[4/3] overflow-hidden">
        ...
        <div className="absolute top-2 right-2 bg-orange-500 text-white px-2 py-1 rounded-full text-xs font-bold shadow-lg">⭐ Special</div>
      </div>
