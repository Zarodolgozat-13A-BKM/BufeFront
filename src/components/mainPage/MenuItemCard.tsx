...
export const MenuItemCard = ({ item, quantity, showModal }: MenuItemCardProps) => {
  return (
    <div className="relative flex items-center gap-4 bg-white dark:bg-gray-900 p-3 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg hover:border-orange-500/50 transition-all group cursor-pointer">
      ...
      {item.is_featured ? (
        <div className="absolute top-3 right-3 w-10 h-10 flex items-center justify-center bg-orange-500 text-white rounded-full shadow-lg">
