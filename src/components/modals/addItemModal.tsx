            ...
            <div className="flex flex-col gap-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex gap-3 pt-4">
                        <button onClick={handleAddToCart} disabled={!item.is_active} className={`flex-1 py-3 rounded-lg font-bold bg-black text-white transition-all ${item.is_active ? 'bg-primary hover:bg-primary-strong active:scale-[0.98]' : 'bg-gray-400 cursor-not-allowed'}`}  >
                            {item.is_active ? (
