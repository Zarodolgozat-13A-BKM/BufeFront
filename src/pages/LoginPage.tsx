            ...
            <div className="relative z-10 w-full max-w-md px-4 py-6 sm:max-w-lg sm:px-6 sm:py-8 lg:max-w-5xl lg:scale-[1.5] lg:origin-center">
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    required
                                    className={"w-full pl-10 pr-4 py-3 rounded-lg border bg-white/30 text-slate-200 placeholder-slate-200 focus:outline-none focus:ring-2 focus:ring-primary transition-all " + (usernameError ? "border-red-400 focus:ring-red-400/40" : "border-slate-300/50")}
                                />
                            </div>
                            {usernameError && (
                                <p className="mt-1 text-xs font-medium text-red-300">{usernameError}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    required
                                    className={"w-full pl-10 pr-10 py-3 rounded-lg border bg-white/30 text-slate-200 placeholder-slate-200 focus:outline-none focus:ring-2 focus:ring-primary transition-all " + (passwordError ? "border-red-400 focus:ring-red-400/40" : "border-slate-300/50")}
                                />
                            ...
                            {passwordError && (
                                <p className="mt-1 text-xs font-medium text-red-300">{passwordError}</p>
                            )}
                        </div>
                ...
                <div className="text-center mt-8 text-slate-600 dark:text-slate-400">
                    <div className="flex justify-center gap-6 text-xs uppercase tracking-widest text-slate-400 dark:text-slate-400">
                        <a target='_blank' href="https://gyor-jedlik.cms.intezmeny.edir.hu/uploads/GYSZC_Jedlik_Anyos_Technikum_GDPR_Adatkezelesi_es_adatvedelmi_szabalyzat_hatalyos_2022_01_01_tol_fca5c07ebb.pdf" className="hover:text-slate-300 text-white">Adatkezelés</a>
                        <h1 className='text-white'>{new Date().getFullYear()} BKM - Jedlik</h1>
                    </div>
                </div>
            </div>
        </div>
