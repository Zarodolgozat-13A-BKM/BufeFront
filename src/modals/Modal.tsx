	...
	return (
		<div className='fixed inset-0 z-50 flex items-center justify-center p-4'>
			...
			<div
				...
				className={`modal-shell relative bg-white dark:bg-zinc-900 rounded-xl border border-[#e6e0db] dark:border-zinc-700 shadow-2xl w-full ${maxWidthClasses[maxWidth]} max-h-[90vh] overflow-hidden flex flex-col`}>
				{title && (
